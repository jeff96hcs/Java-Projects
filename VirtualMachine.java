...
public class VirtualMachine {
    ...
    protected boolean addressResolved = false;
    //a map with the String variable name as the key and the integer value as 
    //the value
    protected Map<String, Integer> VarsAndInts = new HashMap<String, Integer>();
    ...
    public int runStackTotalFrameSize(){
        return runStack.totalRunStackSize();
    }
    
    public int runStackLastFrameSize(){
        return runStack.getLastFrame().size();
    }
