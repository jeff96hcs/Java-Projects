...
public class RunTimeStack {
    ...
    public static boolean dumpON = false;
    ...
    public void newFrameAt(int offset){
        ...
        if(offset!=0){
            ...
            int i = startEnt;
            while(i < runStack.lastElement().size()){
        ...
        //framePointers
        framePointers.push(totalRunStackSize());
    }
    ...
    public int totalRunStackSize(){
        int totalSize= 0;
        for(int i = 0; i<size(); i++){
            totalSize+=get(i).size();
        }
        return totalSize;
    }
